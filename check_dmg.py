...
for step_idx, step in enumerate(r['steps']):
    for p in step:
        ...
        for log in logs:
            ...
            if log.get('type') == 15 and log.get('playerIndex') == 0 and log.get('attackId') == 458:
                print(f"Xerneas attacked!")
                # Get Opponent BEFORE
                ...
                if current and current.get('players'):
                    ...
                    if active_list and active_list[0]:
                        ...
                        print(f"Opponent BEFORE: HP={active.get('hp')}, DMG={active.get('damage')}")
                    ...
                    for np in next_step:
                        ...
                        if ncurrent and ncurrent.get('players'):
                            ...
                            if nactive_list and nactive_list[0]:
                                ...
                                print(f"Opponent AFTER: DMG={nactive.get('damage')}")
                            else:
                                print(f"Opponent AFTER: NONE (Killed!)")
                            break
                print("")
